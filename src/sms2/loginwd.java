 ...
 * @author skdie
 */
public class loginwd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 410, 10, 40));

        jSeparator2.setOrientation(javax.swing.SwingConstants.VERTICAL);
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 330, 10, 40));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sms2/img/login.png"))); // NOI18N
   ...
   public String aaa(String a)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginwd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
