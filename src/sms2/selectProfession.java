 ...
 * @author skdie
 */
public class selectProfession extends javax.swing.JFrame {

    /**
     * Creates new form selectProfession
     */
    public selectProfession() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Create/Add registration");
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sms2/search_icon.png"))); // NOI18N
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 43, -1));
        ...
        jPanel2.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 190, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(selectProfession.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new selectProfession().setVisible(true);
            }
        });
    }
