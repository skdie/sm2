 ...
 * @author skdie
 */
public class show_wd extends javax.swing.JFrame {
    DefaultTableModel model;

    /**
     * Creates new form newwd
     */
    public show_wd() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(109, 50, 190, 20));
        ...
        td.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Class", "Section", "Roll no", "Father name", "Mother  name", "Address", "Gender", "Relligion", "Father's no.", "DOB"
            }
        ));
        ...
        jPanel2.add(search, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 20, 189, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int column1 = 0;
        int idd = td.getSelectedRow();
        String id1 = td.getModel().getValueAt(idd, column1).toString();
        ...
        try{
            ...
            con=DriverManager.getConnection(path,"root","");
                stmt=con.createStatement();
                stmt.executeUpdate("delete from `data` where `id`='"+id1+"'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String id = td.getModel().getValueAt(row1, column1).toString();
        ...
        try{
                ...
                con=DriverManager.getConnection(path,"root","");
                stmt=con.createStatement();
                stmt.executeUpdate("INSERT INTO `search` (`id`) VALUES ('"+id+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(show_wd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
