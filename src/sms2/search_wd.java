 ...
 * @author skdie
 */
public class search_wd extends javax.swing.JFrame {
 String a;
    /**
     * Creates new form search_wd
     */
    public search_wd() {
    ...
    private void initComponents() {
        ...
        select.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "name", "Roll No", "Class", "Section", "Roll No", "Gender", "Religion" }));
        select.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                selectActionPerformed(evt);
            }
        });
        jPanel3.add(select, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 42, 100, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         a=(String)select.getSelectedItem();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_wd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
