 ...
 * @author skdie
 */
public class staff_show extends javax.swing.JFrame {
     DefaultTableModel model;

    /**
     * Creates new form staff_show
     */
    public staff_show() {
        initComponents();
           ...
           try
        {
            ...
            ps=con.prepareStatement("Select * from `teacher` ORDER BY `id` desc");
            rs=ps.executeQuery();
    ...
    private void initComponents() {
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(36, 42, 748, 363));
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(265, 423, 100, 40));
        ...
        jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(465, 423, 100, 40));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 60, 820, 480));

        jPanel8.setBackground(new java.awt.Color(218, 232, 202));
        jPanel8.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel8.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 19, 43, -1));
        ...
        jPanel8.add(search, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 28, 230, -1));

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sms2/search_icon.png"))); // NOI18N
        jPanel8.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 43, -1));
        jPanel8.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 240, 30));

        getContentPane().add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 0, 820, 60));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            con=DriverManager.getConnection(path,"root","");
            stmt=con.createStatement();
            stmt.executeUpdate("INSERT INTO `check` (`id`) VALUES ('"+id+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(staff_show.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new staff_show().setVisible(true);
            }
        });
    }
